...
assert.ok(
    ...
    'OPENAI_API_KEY is not defined in .env file'
);
...
assert.ok(
    ...
    'PINECONE_API_KEY is not defined in .env file'
);
...
assert.ok(
    ...
    'PINECONE_DEFAULT_INDEX_NAME is not defined in .env file'
);
...
assert.ok(
    ...
    'PINECONE_DEFAULT_NAMESPACE is not defined in .env file'
);
