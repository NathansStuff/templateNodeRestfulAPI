...
export async function findInfoForQuery(question: string, namespace?: string): Promise<string[]> {
...
export function buildQueryTemplate(question: string, matchedText: string[]): string {
    const query = `
