...
import {
    ...
    getIndexes,
    queryIndex,
} from './pineconeIndexService';

export async function getIndexesHandler(
    req: Request,
    res: Response
): Promise<void> {
...
export async function deleteIndexHandler(
    req: Request,
    res: Response
): Promise<void> {
...
export async function createIndexHandler(
    req: Request,
    res: Response
): Promise<void> {
...
export async function queryIndexHandler(
    req: Request,
    res: Response
): Promise<void> {
